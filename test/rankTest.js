...
rankTest('test25: given voyage with china 12 and history length 5 when rating return A', t => {
  //given
  const voyage = {
    zone: 'china',
    length: 12,
...
rankTest('test26: given voyage with china 12 and empty history cover the voyageProfitFactor when rating then return A', t => {
  //given
  const voyage = {
    zone: 'east-indies',
    length: 15,
